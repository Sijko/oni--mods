...
namespace NaturalGasScrubber
{
    ...
    public class NaturalGasScrubber : StateMachineComponent<NaturalGasScrubber.StatesInstance>, IEffectDescriptor
    {
        public class StatesInstance : GameStateMachine<States, StatesInstance, NaturalGasScrubber, object>.GameInstance
        {
            public StatesInstance(NaturalGasScrubber smi)
                : base(smi)
            {
            }
        }

        public class States : GameStateMachine<States, StatesInstance, NaturalGasScrubber>
        {
