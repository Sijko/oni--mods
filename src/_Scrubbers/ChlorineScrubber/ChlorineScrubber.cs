...
namespace ChlorineScrubber
{
    ...
    public class ChlorineScrubber : StateMachineComponent<ChlorineScrubber.StatesInstance>, IEffectDescriptor
    {
        public class StatesInstance : GameStateMachine<States, StatesInstance, ChlorineScrubber, object>.GameInstance
        {
            public StatesInstance(ChlorineScrubber smi)
                : base(smi)
            {
            }
        }

        public class States : GameStateMachine<States, StatesInstance, ChlorineScrubber>
        {
