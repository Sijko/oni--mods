...
namespace CoalScrubber
{
    ...
    public class CoalScrubber : StateMachineComponent<CoalScrubber.StatesInstance>, IEffectDescriptor
    {
        public class StatesInstance : GameStateMachine<States, StatesInstance, CoalScrubber, object>.GameInstance
        {
            public StatesInstance(CoalScrubber smi)
                : base(smi)
            {
            }
        }

        public class States : GameStateMachine<States, StatesInstance, CoalScrubber>
        {
